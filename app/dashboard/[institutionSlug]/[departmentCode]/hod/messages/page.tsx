// app/(dashboard)/hod/messages/page.tsx
'use client'
...
import { 
  ...
  AlertCircle, Search, X, Pin, Users
} from 'lucide-react'
...
export default function HODMessagesPage() {
  ...
  const handleStartNewConversation = () => {
    // This would open a modal to select recipient
    alert('Start new conversation - Select a supervisor or student to message')
  }
  ...
  return (
    <DashboardLayout>
      <main className="flex-1 md:ml-0 overflow-hidden">
        <DashboardHeader
          title="Messages"
          subtitle="Communicate with supervisors, students, and department staff"
        />
              ...
              <div className="mb-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" onClick={handleStartNewConversation} variant="outline">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {otherParticipant.role === 'SUPERVISOR' ? 'Supervisor' : 
                             otherParticipant.role === 'STUDENT' ? 'Student' : 
                             otherParticipant.role === 'HOD' ? 'HOD' : otherParticipant.role}
                          </p>
                        </div>
                      </div>
                      <div className="flex gap-2">
                    ...
                    {currentConversation.messages.length === 0 ? (
                      ...
                      currentConversation.messages.map((msg, idx) => (
                        ...
                        >
                          ...
                          {msg.isOwn && (
                            <div className="w-8 h-8 rounded-full bg-blue-600 text-white flex capitalize items-center justify-center text-xs font-bold flex-shrink-0">
