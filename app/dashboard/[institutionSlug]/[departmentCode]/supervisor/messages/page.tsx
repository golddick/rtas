  ...
  return (
    <DashboardLayout>
      <main className="flex-1 md:ml-0 overflow-hidden">
        <DashboardHeader
          title="Messages"
          subtitle="Communicate with your students and colleagues"
        />
                      ...
                      <CardContent className="p-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className={`text-sm capitalize truncate ${conv.unread ? 'font-bold text-foreground' : 'text-foreground'}`}>
                              {conv.name}
                            </p>
